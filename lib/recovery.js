...
function computeTrainingLoadScore(allWorkouts, targetDate) {
  ...
  let score;
  if (tsb > 10) score = 60;
  else if (tsb >= -10) score = 90;
  else if (tsb >= -30) score = 100;
  else if (tsb >= -60) score = 75 + Math.round(((tsb + 60) / 30) * 25);
  else if (tsb >= -100) score = 50 + Math.round(((tsb + 100) / 40) * 25);
  else if (tsb >= -150) score = 30 + Math.round(((tsb + 150) / 50) * 20);
  else score = 15;
