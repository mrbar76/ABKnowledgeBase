...
|---|---|---|---|
| HR samples (per-second during workout) | `workouts.metadata.heartRateData`, then derived `workouts.hr_zones` | Format A/B/D parsers + `computeHrZonesForWorkout` | Series 3 supplies these |
